...
--
-- Host: 127.0.0.1    Database: telco_app_db
-- ------------------------------------------------------
...
INSERT INTO `AudTable` VALUES ('user2@test.com',264,'2022-01-25 05:03:09',3,5),('user3@test.com',252,'2022-01-25 05:04:25',4,6);
...
INSERT INTO `MvProduct` VALUES (17,1,'STAR Channel',720),(18,3,'SuperInternetProtection',95.76),(19,2,'Serie A',900),(20,4,'Champions League',131.88);
...
INSERT INTO `MvSales` VALUES (14,1,1931.4,407.52,2,2,'Super Internet'),(15,3,155.88,108,1,1,'Internet+Phone'),(16,10,635.88,360,1,2,'Ultra Package');
...
INSERT INTO `MvSalesPeriod` VALUES (15,1,1,1,12,'Super Internet'),(16,1,3,1,36,'Super Internet'),(17,3,1,1,12,'Internet+Phone'),(18,10,1,1,12,'Ultra Package');
...
INSERT INTO `Order` VALUES (66,2,1,1,'2022-01-25 05:01:28',347.76,'2022-01-28 00:00:00',1),(67,2,1,3,'2022-01-25 05:01:57',1583.64,'2022-01-28 00:00:00',1),(68,2,3,1,'2022-01-25 05:02:10',155.88,'2022-01-28 00:00:00',1),(69,3,2,1,'2022-01-25 05:02:41',900,'2022-01-28 00:00:00',2),(70,3,2,2,'2022-01-25 05:02:56',1848,'2022-01-28 00:00:00',2),(71,3,4,1,'2022-01-25 05:03:09',264,'2022-01-28 00:00:00',2),(72,4,3,1,'2022-01-25 05:03:36',252,'2022-01-28 00:00:00',2),(73,4,4,1,'2022-01-25 05:03:53',264,'2022-01-28 00:00:00',2),(74,4,4,1,'2022-01-25 05:04:06',264,'2022-01-20 00:00:00',2),(75,4,3,1,'2022-01-25 05:04:25',252,'2022-01-28 00:00:00',2),(76,5,10,1,'2022-01-25 05:06:56',635.88,'2022-01-28 00:00:00',1);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`%`*/ /*!50003 TRIGGER `OrderTrigger` AFTER UPDATE ON `Order` FOR EACH ROW begin
    ...
    if NEW.status = 2 and OLD.status != 2 then
        ...
        set @user_email = (select email from telco_app_db.User u where u.user_id = NEW.user_id);
        set @failed_payment = (select failed_payment from telco_app_db.User u where u.user_id = NEW.user_id);

        update telco_app_db.User
            set insolvent = 1,
                failed_payment = failed_payment + 1
        where user_id = NEW.user_id;
        if @failed_payment >= 2 then
            if @AudTable = 0 then
                insert into telco_app_db.AudTable(user_id, email, ammount, last_rejection)
                    values(NEW.user_id, @user_email, new.total, new.purchase_date);
            else
                update telco_app_db.AudTable
                    set ammount = new.total,
                        last_rejection = new.purchase_date
                where user_id = NEW.user_id;
            end if;
        end if;
    end if;
...
INSERT INTO `OrderProduct` VALUES (66,1),(67,1),(70,1),(71,1),(72,1),(73,1),(74,1),(75,1),(76,1),(67,2),(69,2),(70,2),(66,3),(68,3),(76,4);
...
INSERT INTO `Schedule` VALUES (52,66,'2022-01-28','2023-01-28'),(53,67,'2022-01-28','2025-01-28'),(54,68,'2022-01-28','2023-01-28'),(55,76,'2022-01-28','2023-01-28');
...
INSERT INTO `User` VALUES (2,'user1pass','user1',1,0,0,'user1@test.com'),(3,'user2pass','user2',1,1,3,'user2@test.com'),(4,'user3pass','user3',1,1,4,'user3@test.com'),(5,'user4pass','user4',1,0,0,'user4@test.com'),(6,'user5pass','user5',1,0,0,'user5@test.com'),(7,'user8pass','user8',1,0,2,'user8@test.com'),(8,'admin','admin',2,0,0,'admin@test.com');
...
-- Dump completed on 2022-01-25  6:09:55
